...
namespace Syeremy.Rest
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            endopointConfiguration.PurgeOnStartup(true);
            endopointConfiguration.EnableInstallers();

            endpointInstance = Endpoint.Start(endopointConfiguration).GetAwaiter().GetResult();
